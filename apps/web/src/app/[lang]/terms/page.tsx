            ...
            <Card className="glass-card">
              ...
              <CardContent className="pt-0 space-y-4">
                <p className="text-muted-foreground">
                  ...
                  platform and services. By accessing or using our platform, you agree to be bound
                  by these terms.
                </p>
                <p className="text-muted-foreground">
            ...
            <Card className="glass-card">
              ...
              <CardContent className="pt-0 space-y-4">
                <p className="text-muted-foreground">
                  ...
                  calculated based on match results and tournament participation. We reserve the
                  right to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
