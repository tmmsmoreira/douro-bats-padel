      ...
      <div className="space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              ...
              compete, improve, and enjoy the sport they love.
            </p>
            <p className="text-muted-foreground">
              Our platform simplifies tournament management, player rankings, and event organization, making it easier
              than ever to participate in competitive padel.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-muted-foreground">
              What started as a small local tournament series has grown into a comprehensive platform serving the padel
              community with state-of-the-art technology and a commitment to fair play.
            </p>
            <p className="text-muted-foreground">
              Today, we continue to innovate and improve, always listening to our community and striving to provide the
              best possible experience for everyone involved in the sport.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Fair Play:</strong> We believe in transparent rules and equal opportunities for all players.
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
                <div>
                  <strong>Community:</strong> Building lasting connections and friendships through sport.
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
                <div>
                  <strong>Inclusivity:</strong> Welcoming players of all backgrounds and skill levels.
                </div>
              </li>
            </ul>
          </CardContent>
