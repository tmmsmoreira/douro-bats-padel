          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                functionality such as security, authentication, and accessibility. The platform
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>
                  <strong>Analytics Services:</strong> To understand platform usage and improve our
                  services
                </li>
              </ul>
              <p className="text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                are used to remember your preferences and settings across multiple sessions.
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              ...
              <p className="text-muted-foreground mt-4">
                ...
                platform may not function properly, and you may not be able to access certain areas
                of the platform.
              </p>
