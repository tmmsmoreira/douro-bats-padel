            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Badge variant={player.player.status === "ACTIVE" ? "default" : "secondary"} className="mt-1">
              ...
              <div className="pt-4 border-t">
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="font-medium">{new Date(player.player.createdAt).toLocaleDateString()}</p>
                  </div>
                  <div>
