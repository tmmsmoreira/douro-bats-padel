        ...
        <Card className="glass-card">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              At Douro Bats Padel, we take your privacy seriously. This Privacy Policy explains how
        ...
        <Card className="glass-card">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              ...
              services (such as Google OAuth). We are not responsible for the privacy practices of
