      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `html{background:#fafafa;color:#1a1a1a}@media(prefers-color-scheme:dark){html{background:#1a1a1a;color:#f5f5f5}}.dark html,html.dark{background:#1a1a1a;color:#f5f5f5}#static-splash{position:fixed;inset:0;z-index:9999;display:flex;align-items:center;justify-content:center;background:#fafafa;color:#1a1a1a}@media(prefers-color-scheme:dark){#static-splash{background:#1a1a1a;color:#f5f5f5}}.dark #static-splash{background:#1a1a1a;color:#f5f5f5}`,
          }}
        />
