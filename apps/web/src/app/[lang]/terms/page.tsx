      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12 max-w-4xl flex-1">
        <div className="space-y-6 sm:space-y-8">
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              <p className="text-muted-foreground">
                To participate in tournaments and access certain features, you must create an
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              <p className="text-muted-foreground">
                ...
                property of Douro Bats Padel or its licensors and is protected by copyright and
