    ...
    <PageLayout nav={<HomeNavClient />}>
      <div className="space-y-6 sm:space-y-8">
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              Welcome to Douro Bats Padel. These Terms and Conditions govern your use of our
              platform and services. By accessing or using our platform, you agree to be bound by
              these terms.
            </p>
            <p className="text-muted-foreground">
              If you do not agree with any part of these terms, you may not access the platform or
              use our services.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              To participate in tournaments and access certain features, you must create an account.
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            ...
            <p className="text-muted-foreground">
              Failure to comply with these requirements may result in disqualification, suspension,
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              Our ranking system is designed to fairly assess player performance. Rankings are
              calculated based on match results and tournament participation. We reserve the right
              to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              Some tournaments may require entry fees. All fees are non-refundable unless the
              tournament is cancelled by the organizers. Payment must be made in full before the
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              ...
              property of Douro Bats Padel or its licensors and is protected by copyright and other
        ...
        <Card className="glass-card">
          ...
          <CardContent className="pt-0 space-y-4">
            <p className="text-muted-foreground">
              Douro Bats Padel is not liable for any injuries, losses, or damages that may occur
              during tournament participation. Users participate at their own risk and are
